<?php 
 ...
 // select loggedin users detail
  ...
  $res=mysqli_query($conn, "SELECT id, book_name,book_price,books_quantity,book_front_image,book_description,book_author from books_store where book_category='Science'");

    $searchRes=mysqli_query($conn, "SELECT id, book_name,book_price,books_quantity,book_front_image,book_description,book_author from books_store where book_name like '%$search%' and book_category='Science'");
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h4 class="module-title font-alt">Purchase Science books today</h4>
