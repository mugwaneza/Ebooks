<?php 
 ...
 // select loggedin users detail
  ...
  $res=mysqli_query($conn, "SELECT id, book_name,book_price,books_quantity,book_front_image,book_description,book_author from books_store where book_category ='Politics'");

    $searchRes=mysqli_query($conn, "SELECT id, book_name,book_price,books_quantity,book_front_image,book_description,book_author from books_store where book_name like '%$search%' and book_category ='Politics'");
   ...
   <section class="home-section bg-dark-60 portfolio-page-header parallax-bg" id="home" data-background="assets/images//portfolio/portfolio_header_bg.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="font-alt mb-40 titan-title-size-4">Online books selling</div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h4 class="module-title font-alt">Purchase Politics books today</h4>
