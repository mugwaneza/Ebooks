...
// Get client history
 ...
 $resord=mysqli_query($conn, "SELECT
  sold_books.books_quantity,
  sold_books.price,
  books_store.book_front_image,
  books_store.book_author,
  books_store.book_name
   FROM
 sold_books,books_store
  WHERE 
books_store.id = sold_books.book_id 
    ...
    <body>
        ...
        <div class="wrapper">
         ...
         <span><?php echo $row['client_fullname']?></span>
          ...
          <div class="container">
           <div class="row">
   <?php while($myordersRow=mysqli_fetch_array($resord)) { ?> 
    <div class="col-md-2 offset-md-2">
       <div class='thumbnail'>
      
  <?php echo '<img src="data:photo/jpeg;base64,'.base64_encode($myordersRow['book_front_image'] ).'" width="300" height="300"/><br/>'  ; ?> 

     <div class='caption'>
  <p><span class="fa fa-book">&nbsp;<?php echo $myordersRow['book_name'] ?></span><br><br> 
   By <span class="post-meta">&nbsp;<b><?php echo $myordersRow['book_author'] ?></b></span><br>
  <span class="fa fa-bookmark "></span>Sold: <?php echo $myordersRow['price'] ?>Rwf<br><br>
 <span class="fa fa-bar-chart">Sold quantity: <span class="post-meta">&nbsp;<?php echo $myordersRow['books_quantity'] ?></span>
     </p>
